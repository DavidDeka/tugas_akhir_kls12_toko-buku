      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          <div class="box-header">
            <a href="index.php?page=tambah_kasir" class="btn btn-primary" role="button" title="Tambah Data"><i
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="javascript:void(0);" class="btn btn-danger" role="button" title="Hapus Data"
                        onclick="hapusKasir(<?= $row['id_kasir']; ?>);"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>
                  </tr>
