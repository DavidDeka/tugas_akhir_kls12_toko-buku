    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-mini"><b>To</b>Ko</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>TOKO</b>KOMIK</span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Toko <a href="http://almsaeedstudio.com">Komik Makmur</a>.</strong> Semua komik ada
      </footer>
